...
async function getAppleOrchard(locale: string): Promise<AppleOrchardData> {
  try {
    ...
    const data: RawAppleOrchardData = Array.isArray(result.data)
      ? result.data[0]
      : result.data;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div
                      ...
                      <span
                        className={`material-symbols-outlined ${
                          mytheme === "dark" ? "text-white" : "text-yellow-600"
                        }`}>
                        {feature.icon}
                      </span>
                    </div>
            ...
            <motion.div
              ...
              <div className="relative w-full max-w-md">
                <div
                  className={`relative h-[700px] md:w-[380px] w-full rounded-3xl overflow-hidden shadow-2xl ${
                    mytheme === "light"
                      ? "shadow-gray-200/80"
                      : "shadow-black/50"
                  } aspect-[3/4]`}>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div
                      className={`p-4 rounded-xl backdrop-blur-md ${
                        mytheme === "light" ? "bg-white/70" : "bg-gray-900/70"
                      }`}>
