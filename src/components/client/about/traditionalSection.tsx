...
export default function MaximaVsTraditionalSection() {
  ...
  if (!data) {
    return (
      <div className={`flex items-center justify-center py-20 ${mytheme === "light" ? "text-gray-800" : "text-gray-200"
        }`}>
  ...
  return (
    <ConfigProvider theme={themeConfig}>
      <div id="become-ib" className={`py-20 md:py-28 relative overflow-hidden font-inter ${mytheme === "light"
          ? "bg-gray-50"
          : "bg-gray-950"
        }`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 relative z-20">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <h2 className={`text-3xl md:text-4xl font-bold mb-4 ${mytheme === "light" ? "text-gray-900" : "text-white"
              }`}>
              {title}
            </h2>
            <div className="w-24 h-1 bg-yellow-500 mx-auto mb-4"></div>
            <p className={`text-lg max-w-3xl mx-auto ${mytheme === "light" ? "text-gray-600" : "text-gray-300"
              }`}>
              {subtitle}
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 items-stretch">
            <motion.div
              className={`rounded-2xl shadow-xl overflow-hidden ${mytheme === "light"
                  ? "bg-white"
                  : "bg-gray-900"
            ...
            >
              <div className={`px-6 py-6 ${mytheme === "light"
              ...
              <div className="p-6 space-y-6 h-full">
                {traditional_points.length > 0 ? (
                  traditional_points.map((point, index) => (
                    <motion.div
                      key={index}
                      className={`p-4 rounded-lg ${mytheme === "light"
                          ? "bg-red-50"
                          : "bg-red-900/20"
                        }`}
                    ...
                    >
                      <div className="flex items-center gap-3 mb-2">
                        <div className={`flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full ${mytheme === "light"
                        ...
                        <h4 className={`font-semibold text-lg ${mytheme === "light"
                            ? "text-gray-900"
                            : "text-white"
                          }`}>
                          {point.title}
                      ...
                      <p className={`pl-11 text-base ${mytheme === "light"
                          ? "text-gray-600"
                          : "text-gray-300"
                        }`}>
                  ...
                  <p className={`text-base ${mytheme === "light"
                      ? "text-gray-600"
                      : "text-gray-300"
                    }`}>
                    No points available
          ...
          >
            <motion.div
              className={`rounded-lg p-6 ${mytheme === "light"
                  ? "bg-white shadow-lg"
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${mytheme === "light"
                    ? "bg-blue-100"
                    : "bg-blue-900/30"
                  }`}>
